...
python main.py \
  ...
  --checkpoint_path /media/kaneki/5490675f-8f6a-4932-bae3-f457edde3ca0/wujiaqi/code/experiments/UAV_20260424_125807/models/epoch_11.pth \
  --cnn_input_mode mask \
  --run_mode infer \
  --exclude_classes FPV1 \
  --eval_exclude_classes FPV1 # Skylink21 Skylink11 Background
 # 
