...
def get_parser():
    ...
    g_yolo.add_argument("--yolo_iou_thres", type=float, default=0.30)
    ...
    g_yolo.add_argument("--yolo_input_p_high", type=float, default=99.5)
    ...
    g_pre.add_argument("--min_contrast_z", type=float, default=-2.0)
