#!/bin/bash
python main.py \
  --train_dataset_path /media/kaneki/05E4235537EC7AC2/dataset_wjq/DroneRFa_png_new/train \
  --val_dataset_path /media/kaneki/05E4235537EC7AC2/dataset_wjq/DroneRFa_png_new/val \
  --input_type png \
  --epochs 300 \
  --batch_size 128 \
  --lr 1e-4 \
  ...
  --bbox_cache_dataset_root /media/kaneki/05E4235537EC7AC2/dataset_wjq/DroneRFa_png_new \
